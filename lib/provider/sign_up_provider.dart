  ...
  Future<void> signUp(BuildContext context)async{
    try{
      ...
      if(_passwordController.text == _confirmPasswordController.text){
        await _authModel.register(email: _emailController.text, password: _passwordController.text,name: _userNameController.text,phoneNumber: _phoneController.text);
        navigateToScreen(const NavigationMenu(), context);
      }
      _isLoading = false;
      notifyListeners();
    }catch (e){
